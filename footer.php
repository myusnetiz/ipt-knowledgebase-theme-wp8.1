	 ...
	 wp_reset_query();?>
			...
			<div class="site-info text-light" style="background:#222; padding-top:20px; padding-bottom:20px;">
				<div class="container">
					<div class="row">
						<div class="col-md-3">
							<a href="https://kutuphanemizden.com" rel="nofollow noreferrer noopener" target="_blank" title="Kütüphanemizden"><img src="<?php echo get_bloginfo('template_directory');?>/images/logow.png" style="margin-right:10px;"></a> &copy; <?php echo date('Y'); ?> <span style="color: white;">·</span> <a style="color: white;" href="https://github.com/swashata/ipt-knowledgebase-theme-wp" rel="nofollow noreferrer noopener" target="_blank" title="WP Knowledge Base Theme">KBT</a>
					</div>
