...
class IPT_KB_Social_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$settings_helper = array(
			'social_titles' => array(
			'x' => __( 'X üzerinden bize katılınız', 'ipt_kb' ),
			'mastodon' => __( 'Mastodon üzerinden bize katılınız', 'ipt_kb' ),
    			'pixelfed' => __( 'Pixelfed sayfamıza Abone Olunuz', 'ipt_kb' ),
    			'instagram' => __( 'Instagram üzerinden bize katılınız', 'ipt_kb' ),
    			'youtube' => __( 'Youtube kanalımıza abone olunuz', 'ipt_kb' ),
    			'rumble' => __( 'Rumble üzerinden bize katılınız', 'ipt_kb' ),
    			'twitch' => __( 'Twitch ile içerik Gönderiniz', 'ipt_kb' ),
    			'telegram' => __( 'Telegrsm ile içerik Gönderiniz', 'ipt_kb' ),
			...
			'x' => 'fa fa-x',
			'mastodon' => 'fa fa-mastodon',
    			'pixelfed' => 'fa fa-camera',
    			'instagram' => 'fa fa-instagram',
    			'youtube' => 'fa fa-play-circle',
    			'rumble' => 'fa fa-play-circle',
    			'twitch' => 'fa fa-twitch',
