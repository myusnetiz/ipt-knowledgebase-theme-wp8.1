	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					...
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Fabrika ayarlarına sıfırla', 'theme-textdomain' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Tamam tuşuna basarsanız yaptığınız tüm değişiklikler gidecek.', 'theme-textdomain' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
